...
export const servicesNavBarCompDataArr = [
  { label: "AI Automation Service", icon: Bot, renderUi: "aiAuto" },
  { label: "AI Agent Development", icon: BrainCircuit, renderUi: "aiAgentDev" },
  {
  ...
  { label: "DevOps And Cloud Services", icon: Cloud, renderUi: "devOps" },
  { label: "Digital Marketing", icon: Megaphone, renderUi: "digiMart" },
] as const;
...
export const renderUiCompDataArr = [
  {
    ...
    rightImg: {
      src: "/images/services/AiAutoRightImg.png",
      width: 486,
      height: 486,
    },
    paraButtom:
    ...
    servicesSection: [
      ...
      {
        lable: "Conversational AI & Chatbots",
        icon: "/images/services/chatbot.png",
      },
      {
        lable: "Business Intelligence Automation",
        icon: "/images/services/business_intelligence_image.png",
      },
      {
        lable: "Integration with Existing Tools",
        icon: "/images/services/integration_image.png",
      },
    ],
  },
  {
    ...
    subHeading:
      "Build intelligent AI agents that work smarter for your business",
    paragraph:
    ...
    rightImg: {
      src: "/images/services/ai-agent-service.png",
      width: 394,
      height: 353,
    },
    paraButtom:
    ...
    servicesSection: [
      {
        lable: "Conversational Agents",
        icon: "/images/services/talk_image.png",
      },
      {
        lable: "Task Oriented Agents",
        icon: "/images/services/settings_image.png",
      },
      {
        lable: "Decision Making Agents",
        icon: "/images/services/decision-making_image.png",
      },
      {
        lable: "Integration Agents",
        icon: "/images/services/connectivity_image.png",
      },
      {
        lable: "Learning Agents",
        icon: "/images/services/knowledge_image.png",
      },
    ],
  },
  {
    ...
    rightImg: {
      src: "/images/services/ai-chatboat-service.png",
      width: 479,
      height: 314,
    },
    paraButtom:
    ...
    servicesSection: [
      {
        lable: "Customer Support Bots",
        icon: "/images/services/human_image_cc.png",
      },
      {
        lable: "E-Commerce Bots",
        icon: "/images/services/shop-assistant_image.png",
      },
      {
        lable: "Lead Generation Bots",
        icon: "/images/services/target-person_image.png",
      },
      {
        lable: "Internal Process Bots",
        icon: "/images/services/process_w-f-a.png",
      },
      {
        lable: "Multichannel Integration",
        icon: "/images/services/flexibility_wfa.png",
      },
    ],
  },
  {
    ...
    subHeading:
      "Streamline your business processes with smart workflow automation",
    paragraph:
    ...
    rightImg: {
      src: "/images/services/ai-workflow-service.png",
      width: 402,
      height: 420,
    },
    paraButtom:
    ...
    servicesSection: [
      {
        lable: "Business Process Automation",
        icon: "/images/services/management_wfa.png",
      },
      {
        lable: "End-to-End Task Automation",
        icon: "/images/services/order-processed_wfa.png",
      },
      {
        lable: "Data Integration & Processing",
        icon: "/images/services/data-management_wfa.png",
      },
      {
        lable: "Employee Productivity Tools",
        icon: "/images/services/human_image_cc.png",
      },
      {
        lable: "Customer Journey Automation",
        icon: "/images/services/connectivity_image.png",
      },
    ],
  },
  {
    ...
    rightImg: {
      src: "/images/services/ai-web-mobile-service.png",
      width: 600,
      height: 350,
    },
    paraButtom:
    ...
    servicesSection: [
      {
        lable: "Android App Development",
        icon: "/images/services/andoridimg.png",
      },
      { lable: "iOS App Development", icon: "/images/services/iosapp.png" },
      {
        lable: "Cross-Platform App Development with Flutter",
        icon: "/images/services/flutter.png",
      },
      {
        lable: "App Support & Maintenance",
        icon: "/images/services/Smartphone_Maintenance.svg",
      },
  ...
  },
  {
    ...
    rightImg: {
      src: "/images/services/ai-devops-service.png",
      width: 513,
      height: 513,
    },
    paraButtom:
    ...
    servicesSection: [
      ...
      {
        lable: "Cloud Formation",
        icon: "/images/services/AiImageEnhancer.svg",
      },
    ],
  },
  {
    ...
    subHeading:
      "Elevate your digital presence with strategic digital marketing activities",
    paragraph:
    ...
    rightImg: {
      src: "/images/services/ai-digital-service.png",
      width: 497,
      height: 376,
    },
    paraButtom:
    ...
    servicesSection: [
      ...
      {
        lable: "Social Media Marketing",
        icon: "/images/services/digital-campaign.svg",
      },
      {
        lable: "Social Media Optimization",
