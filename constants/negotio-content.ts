export const negotioShowcaseContent = {
  ...
  benefitsTitle: "Benefits Over Traditional Booking;",
  benefits: [
    "Saves time by negotiating instantly.",
    "Saves money with better rates from live pricing.",
    "Secure bookings, protected through verified authentication.",
  ],
} as const;
